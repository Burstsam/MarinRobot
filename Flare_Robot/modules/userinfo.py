...
def info(update: Update, context: CallbackContext):
    ...
    rep = message.reply_text("<code>Gathering Info From Marin's Notebook</code>", parse_mode=ParseMode.HTML)
    ...
    if user.id == OWNER_ID:
        text += "\n\nThe Disaster level of this person is <b>'My Hubby'</b>."
        disaster_level_present = True
    elif user.id in DEV_USERS:
        text += "\n\nThis user is member of the 'My Relative'."
        disaster_level_present = True
    elif user.id in DRAGONS:
        text += "\n\nThe Disaster level of this person is 'My Close Friend'."
        disaster_level_present = True
    elif user.id in DEMONS:
        text += "\n\nThe Disaster level of this person is 'My Friend'."
        disaster_level_present = True 
    elif user.id in TIGERS:
        text += "\n\nThe Disaster level of this person is 'My Classmate'."
        disaster_level_present = True
    elif user.id in WOLVES:
        text += "\n\nThe Disaster level of this person is 'My Fake Friend'."
        disaster_level_present = True

    if disaster_level_present:
        text += ' [<a href="https://t.me/Marin_Updates/4">◉</a>]'.format(
            bot.username,
        )
...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(
            ...
            + f"\n\n[ Support](https://t.me/{SUPPORT_CHAT}) | [ Updates](https://t.me/Marin_Updates)\n\n"
            + "╘══「 by [ᴘᴀɴᴅᴀ](https://t.me/AstaSilva02) 」\n",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
        )
