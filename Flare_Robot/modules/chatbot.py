    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Marin Chatbot disable by {}. ".format(mention_html(user.id, user.first_name)),
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "Marin Chatbot enable by {}. Has Hindi And English Language Support".format(mention_html(user.id, user.first_name)),
                parse_mode=ParseMode.HTML,
            )
